...
QVariant AllEventsModel::data(const QModelIndex& idx, int role) const
{
    assert(idx.isValid());
    assert(idx.column() < 2);
...
int AllEventsModel::columnCount(const QModelIndex& parent) const
{
...
void AllEventsModel::refreshData()
{
    /*
